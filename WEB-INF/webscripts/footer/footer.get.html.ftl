...
-->
<div class="centered">
${version} - <a target="_blank" id="support"></a>
</div>
<script type="text/javascript">
    var helper = ${properties};
    $("#support").attr('href', helper["parapheur.ihm.contact.support.url"]);
    $("#support").text(helper["parapheur.ihm.contact.support.text"]);
</script>
