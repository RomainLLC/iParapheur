 ...
 */
/**
 * Modification mineures - Lukas Hameury
 * ajout d'options dans les méthodes des resources :
 *  - extend : étend l'objet en cours avec la réonse à la requete (la réponse doit être un objet JSON)
 *  - action : traite l'objet comme une action, ne modifie pas l'objet, envoi des paramètres dans le corps de la requete (JSON), sauf ceux noté dans "params".
 */
            ...
            function resourceFactory(url, paramDefaults, actions) {
                ...
                forEach(actions, function(action, name) {
                    ...
                    Resource[name] = function(a1, a2, a3, a4) {
                        ...
                        if(action.action) {
                            if (hasBody) httpConfig.data = params;
                        ...
                        var promise = $http(httpConfig).then(function(response) {
                            ...
                            if (data) {
                                ...
                                if(action.extend) {
                                    //Edit Lukas -> Pour faire une extension d'un objet deja exixtant
                                    if (action.extendParameter) {
                                        var tmp = {};
                                        tmp[action.extendParameter] = data;
                                        data = tmp;
                                    }
                                    extend(value, data);
                                ...
                                // jshint +W018
                                    ...
                                    //Edit Lukas -> Changement du promise seulement, conservation de l'objet
                                    value.$promise = promise;
                                } else {
